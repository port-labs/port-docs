...
const limitations = {
  ...
  Jira:
    ...
    '    - Due to restrictions on the [Jira OAuth2 App](https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-webhooks/#api-rest-api-2-webhook-post), Only a single(first) OAuth Jira installation will receive live events.' + '\n' +
    '    - Due to restrictions on the [Jira OAuth2 App](https://developer.atlassian.com/cloud/jira/platform/rest/v2/api-group-webhooks/#api-rest-api-2-webhook-post), webhooks are not deleted when the app is deleted. To replace the webhook destination, contact support.' + '\n',
  Gitlab:
    defaultLimitations.ttl + '\n' +
    '- For OAuth based installations:' + '\n' +
