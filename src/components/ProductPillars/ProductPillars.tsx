...
const ProductPillars: React.FC = () => {
  const pillars = [
    ...
    },
    {
      ...
      demoUrl: 'https://demo.port.io/service_catalog',
      icon: 'lists',
    },
    {
      title: 'Actions',
      ...
      demoUrl: 'https://demo.port.io/self-serve',
      icon: 'bolt',
    },
    {
      title: 'AI agents',
      ...
      demoUrl: 'https://demo.port.io/organization/home',
      icon: 'stars_2',
    },
    {
      ...
      demoUrl: 'https://demo.port.io/settings/automations',
      icon: 'play_circle',
    },
    {
      title: 'Scorecards',
      ...
      demoUrl: 'https://demo.port.io/serviceEntity?identifier=authentication&activeTab=2',
      icon: 'military_tech',
    },
    {
      ...
      demoUrl: 'https://demo.port.io/engineering_overview',
    ...
    },
    {
      ...
      demoUrl: 'https://demo.port.io/settings/users',
