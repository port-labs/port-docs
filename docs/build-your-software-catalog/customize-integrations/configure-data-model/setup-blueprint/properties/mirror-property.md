...
In this [live demo](https://demo.port.io/_teamEntity?identifier=guardians_of_the_galaxy) example, we can see the `Manager` property which is a mirror property of the related `User` blueprint. 🎬
