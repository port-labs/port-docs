...
**Note:** only users with the [admin](/sso-rbac/users-and-teams/manage-users-teams#roles--permissions) role can use Port's UI to perform the delete all operation.
