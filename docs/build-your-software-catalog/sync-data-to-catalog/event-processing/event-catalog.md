...
Once you have created all your relations between the blueprints, your catalog should look like this and your Data Model should look like .
...
You can see this event has fields for a README, code samples, mermaid architecture diagrams, and schemas allowing you to have a one stop shop to understand how to ingest and use an event. The event includes a audit log to see any changes made to the schema or event documentation. 

Additionally, in the `Related Entities` section, you'll see the entities in Port that are related to the event. You can see the consumer of the event, the producer of the event, the broker the event was sent to, and the broker the event was sent from.

The arrow in the related entities section indicates whether the event was generated by the related entity or sent to the related entity. This related entity section can be configured by modifying the relations section of the your blueprint for each component in your architecture. You can also view these relationships in a graphical view, by clicking on the `Graph` view button on the top right of the Related Entities table. 

<img src='/img/build-your-software-catalog/sync-data-to-catalog/event-processing/event-catalog-completed-event-entity-example-graph-view.png' width='100%' />
