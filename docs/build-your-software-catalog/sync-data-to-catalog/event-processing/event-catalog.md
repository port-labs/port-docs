...
After creating the producer your example event catalog is done. 
...
Additionally, in the `Related Entities` section, you'll see the entities in Port that are related to the event. You can see the consumer of the event, in addition to the producer and event pipeline entities that generated the event.
