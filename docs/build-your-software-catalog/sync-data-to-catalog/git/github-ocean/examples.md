...
The following example demonstrates how to ingest your GitHub repositories, their software bill of materials (SBOM) to Port, you may use the following Port blueprint definitions and port-app-config.yml:
