...
| --------- | ----------- | ------- | -------- |
| `OCEAN__INTEGRATION__CONFIG__GITHUB_TOKEN` | A GitHub Personal Access Token (PAT) with `repo` and `admin:org` scopes to authenticate with your GitHub Organization. | | ✅  |
