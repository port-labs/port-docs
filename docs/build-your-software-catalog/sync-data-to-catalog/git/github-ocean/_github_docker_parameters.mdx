...
| --------- | ----------- | ------- | -------- |
| `OCEAN__INTEGRATION__CONFIG__GITHUB_TOKEN` | The GitLab access token used to authenticate with your GitLab instance | | ❌   |
| `OCEAN__INTEGRATION__CONFIG__GTIHUB_HOST` | The URL of your GitLab instance (e.g., https://gitlab.com or your self-hosted URL) | | ❌  |
| `OCEAN__INTEGRATION__CONFIG__GTIHUB_ORGANIZATION` | The URL of your GitLab instance (e.g., https://gitlab.com or your self-hosted URL) | | ✅ |
