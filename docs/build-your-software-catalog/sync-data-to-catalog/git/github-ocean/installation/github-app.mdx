...
2. [Install](#installing-ports-github-integration) the GitHub app in your GitHub organization and select repositories.
3. [Deploy](#deployment) Port's GitHub integration Docker image inside your VPC using the app details;
