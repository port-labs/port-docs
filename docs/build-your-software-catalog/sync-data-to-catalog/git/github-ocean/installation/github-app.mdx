...
This page details how to install Port's GitHub integration using [GitHub App](https://docs.github.com/en/apps/using-github-apps/about-using-github-apps) credentials. This can be useful if you want the access token to be rotated automatically. #AI! improve this
