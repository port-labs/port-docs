...
This page details how to install Port's GitHub integration using [Github App](https://docs.github.com/en/apps/using-github-apps/about-using-github-apps) credentials. This can be useful if you want the access token used by the integration rotated every hour. # AI! improve this, I'm aiming for more succint and more comprehensible

This page outlines the following steps:

1. [Create](#create-a-github-app) a new app in your GitHub organization;
2. [Install](#installing-github-app) the GitHub app in your GitHub organization and select repositories.
3. [deploy](#deploy-the-integration) the integration in the configuration that fits your use case.
