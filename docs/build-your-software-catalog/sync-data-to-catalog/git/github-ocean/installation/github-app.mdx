...
Using a custom [GitHub App](https://docs.github.com/en/apps/using-github-apps/about-using-github-apps) for Port's integration allows for fine-grained control over permissions and repository access.
