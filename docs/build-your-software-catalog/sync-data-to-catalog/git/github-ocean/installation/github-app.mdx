...
Installing Port's GitHub integration via a custom [GitHub App](https://docs.github.com/en/apps/using-github-apps/about-using-github-apps) provides automatic access token rotation.
