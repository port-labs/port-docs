...
Using a custom [GitHub App](https://docs.github.com/en/apps/using-github-apps/about-using-github-apps) for Port's integration is useful if you want the access token to be rotated automatically.
