...
Using a custom [GitHub App](https://docs.github.com/en/apps/using-github-apps/about-using-github-apps) for Port's integration enhances security through automatically rotated access tokens.
