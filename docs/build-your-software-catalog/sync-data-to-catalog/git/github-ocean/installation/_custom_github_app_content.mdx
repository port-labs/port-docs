...
<img src="/img/integrations/github-ocean/SelfHostedOrganizaionView.png" alt="Org view" width="100%" border="1px" />

2. Inside the settings view, click on **Developer Settings** and then select **GitHub Apps**.

<img src="/img/integrations/github-ocean/SelfHostedOrganizationSettings.png" alt="Settings view" width="100%" border="1px" />

3. Click **New GitHub App**.

<img src="/img/integrations/github-ocean/SelfHostedNewGitHubApp.png" alt="New GitHub App" width="100%" border="1px" />
...
<img src="/img/integrations/github-app/SelfHosetdGeneratePrivayKey.png" alt="Generate private key" width="100%" border="1px" />
...
<img src="/img/integrations/github-ocean/SelfHostedEditGitHubApp.png" alt="GitHub integration installation page" width="100%" border="1px" />
...
<img src="/img/integrations/github-ocean/SelfHostedInstallationRepoSelection.png" alt="GitHub integration installation chooses repositories" width="100%" border="1px" />
