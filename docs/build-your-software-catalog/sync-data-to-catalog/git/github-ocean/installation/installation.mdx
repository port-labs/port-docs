...
1. Navigate to the data sources page in Port.
...
For advanced configurations or if you prefer to manually create the GitHub App, see the [GitHub App installation guide](./github-app.mdx).
