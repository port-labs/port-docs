...
- GitHub App and fine-grained PAT: use `githubOrganization`.
- Do not set `githubOrganization` if you intend syncing multi organizations, instead optionally list the organizations you want in your Port mapping or leave empty to sync all organizations the Classic Personal Access Token user is a member of.
- Performance: syncing multiple organizations increases API calls and may slow down the integration.
- Classic PAT: Multi organization is only support for Classic Personal Access Tokens
:::
