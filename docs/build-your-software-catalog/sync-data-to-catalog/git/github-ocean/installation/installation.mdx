...
import {
  OceanSaasLiveEventsDescription,
  OceanSaasLiveEventsTriggersManual,
  liveEvents,
} from "/src/components/ocean-saas-specifics/live-events.jsx";
...
You can create and install a custom GitHub App directly from Port's UI using OAuth. This is the recommended approach as it streamlines the entire setup process:

1. Navigate to the [data sources](https://app.getport.io/settings/data-sources) page of your portal.

2. Click on `+ Data source` and select `Github-ocean`.

3. Click on the `Connect` button.

4. Select the GitHub organization where you want to install the integration.

5. Enter a custom app name and create it.

6. Install your custom app.

7. Your integration will be ready to use immediately.

<h4>Manual setup</h4>

For advanced configurations or if you prefer to manually create the GitHub App, see the [GitHub App installation guide](./github-app).
