...
<details> <summary>Event grouping behavior</summary>
...
:::note Processing guarantees Events within the same group are processed sequentially to maintain order and prevent conflicts. Different groups can be processed in parallel across workers. With event_workers_count: 1, all events are processed sequentially using a simple queue. :::
