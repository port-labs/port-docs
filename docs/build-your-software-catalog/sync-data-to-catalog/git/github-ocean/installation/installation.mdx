...
#AI! It's still not quite clear that these are 2 options. Let's just put them in tabs 
...
A GitHub App provides automatic access token rotation and is a good alternative to PATs. Refer to our [GitHub App installation guide](./github-app.mdx) to set it up.
