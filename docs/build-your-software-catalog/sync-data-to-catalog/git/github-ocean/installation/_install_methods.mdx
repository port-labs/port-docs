...
| `integration.config.githubAppId`       | The ID of your GitHub App. Required if you are authenticating as a [GitHub App](./github-app.md) instead of using a PAT. | ❌  |
| `integration.secrets.githubAppPrivateKey`       | The base64 encoded private key of your GitHub App. Required if you are authenticating as a GitHub App. | ❌ |
