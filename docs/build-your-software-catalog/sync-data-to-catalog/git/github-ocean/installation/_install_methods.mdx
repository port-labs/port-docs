...
The `OCEAN_BASE_URL` specifies the public-facing URL for your integration. This URL, which must be reachable from the internet, is used to receive real-time updates. It can be a public IP address or a configured domain name (e.g., `https://mygithubintegration.com`).
<details>
