...
#AI! change all CodeBlock elements from here down to use three backtick style ``` as I'm not performing any dynamic codeblock renders
    <TabItem value="docker" label="Docker">
      ...
      <CodeBlock language="nginx" title="/etc/nginx/sites-available/github-ocean.conf" showLineNumbers>
{`server {
    listen 80;
