...
<Tabs groupId="liveEvents" queryString="live-events">
    <TabItem value="kubernetes" label="Kubernetes">
      ...
      :::tip
        You can install setup a local Kubernetes cluster with [Minikube](https://minikube.sigs.k8s.io/docs/)
      :::
      ...
      1. Create or update your `values.yaml` file with the following content:
...
{`
  ...
  ingress:
    enabled: true
    className: "nginx"
    host: "<your-domain>" # e.g myoceangithub.com
    path: "/"
...
`}
      ...
      2. Install or upgrade the Helm chart using the `values.yaml` file:
      <CodeBlock language="bash" showLineNumbers>
{`helm upgrade --install github-ocean port-labs/port-ocean -f values.yaml`}
      </CodeBlock>
