...
| `integration.confg.githubAppId`       | You can start this integration as a (Github app)[./github-app.md], in that case you need to replace githubToken with Github app details, Github app id goes here #AI! improve this description | ❌  |  
| `integration.secrets.githubAppPrivateKey`       | You can start this integration as a Github app, in that case you need to replace githubToken with Github app details, base64 encoded private key goes here #AI! also improve this description | ❌ |  
