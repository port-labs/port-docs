...
<Tabs groupId="liveEvents" queryString="live-events">
    <TabItem value="kubernetes" label="Kubernetes">
      ...
      1. Kubernetes cluster ([Minikube](https://minikube.sigs.k8s.io/docs/start/) is enough for local testing)
      2. Helm

      # Ai! improve this guide, write a step by step guide of creating a kubernetes ingress resource and applying it to a cluster, show an example ingress yaml file.
      When you run the helm installation above, a [Kubernetes service](https://kubernetes.io/docs/concepts/services-networking/service/) is configured for the integration. To enable live-events, we only have to make this service accept outside traffic, to this we configure an ingress resource.
