...
If you deploy the integration outside Port (`Kubernetes`, `Docker`, or `CI`), you need your Port `CLIENT_ID` and `CLIENT_SECRET`.
...
<TabItem value="real-time-self-hosted" label="Kubernetes" default={props.setupName === "app"}>
...
{`
  ...
  integration:
    ...
    type: "github-ocean"
    version: "<CURRENT_INTEGRATION_VERSION>"
    eventListener:
      type: "POLLING"
    config:
  ...
  # uncomment to enable live events or to support actions processing
  # liveEvents:
  #   baseUrl: "<your-domain>"

  # uncomment to enable actions processing
  # actionsProcessor:
  #   enabled: true
...
<CiInstallMethod showingApp={props.setupName == "app"} />
</TabItem>
</Tabs>
