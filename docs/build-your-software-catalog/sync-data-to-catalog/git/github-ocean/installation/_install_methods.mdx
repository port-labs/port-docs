...
<OceanSaasInstallation
  integration="GithubOcean"
  showSelfHostedTip={false}
  dataSourceName="Github"
  showUseCustomSettingsStep={props.showUseCustomSettingsStep}
/>
...
If you deploy the integration outside Port, you need your Port `CLIENT_ID` and `CLIENT_SECRET`:
