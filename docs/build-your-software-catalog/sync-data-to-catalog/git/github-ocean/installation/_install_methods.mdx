...
OCEAN_BASE_URL configures how an external service can reach the integration, it could be the IP address of the host where the integration is deployed or a domain name configured to proxy requests to the host (e.g https://mygithubintegration.com). The URL needs to be accessible from the internet. #Ai! improve this, I'm targetting succint and comprehensible, easy to digest
<details>
