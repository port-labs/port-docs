...
# AI! I want to have integration.config.githubAppId and integration.secrets.githubAppPrivateKey variables here shown when prop.showingApp is true, otherwise integration.secrets.githubToken should be the shown env variable
