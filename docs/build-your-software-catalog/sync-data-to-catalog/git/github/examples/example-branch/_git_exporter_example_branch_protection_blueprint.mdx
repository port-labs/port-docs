  ...
  "schema": {
    "properties": {
      "require_approval_count": {
        ...
        "description": "Specifies the number of approvals required before merging a pull request."
      },
      "is_protected": {
        "title": "Is branch protected",
        "type": "boolean",
        "icon": "DefaultProperty",
        "description": "Indicates whether the branch is protected, enforcing certain rules before changes can be merged."
