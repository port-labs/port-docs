...
For users upgrading from the v1 integration, see our [migration guide](/build-your-software-catalog/sync-data-to-catalog/git/gitlab/migration) to learn how to migrate to the new GitLab-v2 integration.
:::
