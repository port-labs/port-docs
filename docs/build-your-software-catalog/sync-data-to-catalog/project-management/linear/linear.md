...
| `integration.config.appHost` (deprecated)       | The host of the Port Ocean app. Used to set up the integration endpoint as the target for webhooks created in Linear. This field is deprecated. Please use the OCEAN__BASE_URL field instead                                                                                                                                                                           | https://my-ocean-integration.com | ❌        |
