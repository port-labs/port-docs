...
| `OCEAN__INTEGRATION__CONFIG__ATLASSIAN_EMAIL` | The email of the user used to query Jira                                                | ✅       |
| `OCEAN__INTEGRATION__CONFIG__ATLASSIAN_TOKEN` | Jira API token generated by the user specified under atlassianUserEmail ID              | ✅       |
    ...
    steps:
      - name: Run Jira Integration
        run: |
          ...
          -e OCEAN__INTEGRATION__CONFIG__ATLASSIAN_EMAIL=${{ secrets.OCEAN__INTEGRATION__CONFIG__ATLASSIAN_EMAIL }} \
          -e OCEAN__INTEGRATION__CONFIG__ATLASSIAN_TOKEN=${{ secrets.OCEAN__INTEGRATION__CONFIG__ATLASSIAN_TOKEN }} \
