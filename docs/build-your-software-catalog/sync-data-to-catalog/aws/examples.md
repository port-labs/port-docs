...
1.  Create the following Port blueprint:
    ...
    - **EC2** - will represent EC2 instances from the AWS account.

    You may use the following definition:

    <details>
    <summary> EC2 blueprint </summary>

    ```json showLineNumbers
    {
      "identifier": "ec2",
      "description": "This blueprint represents an AWS EC2 in our software catalog",
      "title": "EC2",
      "icon": "EC2",
      "schema": {
        "properties": {
          ...
          EventPattern:
            ...
            detail:
              eventSource:
                - ec2.amazonaws.com
              eventName:
                - prefix: CreateInstances
                - prefix: RunInstances
                - prefix: StartInstances
                - prefix: StopInstances
                - prefix: TerminateInstances
            ...
            - Id: PortAWSExporterEventsQueue
              ...
              InputTransformer:
                InputPathsMap:
                  awsRegion: $.detail.awsRegion
                  eventName: $.detail.eventName
                  requestInstanceId: $.detail.requestParameters.instancesSet.items[0].instanceId
                InputTemplate: |-
                  {
                    "resource_type": "AWS::EC2::Instance",
                    "region": "\"<awsRegion>\"",
                    "identifier": "\"<requestInstanceId>\"",
                    "action": "if \"<eventName>\" | test(\"TerminateInstances[^a-zA-Z]*$\") then \"delete\" else \"upsert\" end"
                  }
    ```
