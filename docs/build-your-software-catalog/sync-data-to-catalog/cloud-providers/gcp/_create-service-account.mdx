<h1> Prerequisites </h1>
Before you begin, ensure that your Google Cloud project has the following APIs enabled. These APIs are crucial for the GCP integration:
...
<h1> Creating a service account </h1>
