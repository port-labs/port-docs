...
- **[Self-hosted](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws-v3/installation/self-hosted.md)**: Deploy the integration in your own infrastructure using Helm, Terraform, or Docker for complete control.
...
- **[Hosted by Port installation](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws-v3/installation/hosted-by-port.md)**: For a fully managed, zero-maintenance experience.
- **[Self-hosted installation](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws-v3/installation/self-hosted.md)**: For deployments in your own infrastructure.

For detailed information about the IAM role architecture for the hosted version, see the [IAM Role Architecture](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws-v3/iam-role-architecture.md) guide.
