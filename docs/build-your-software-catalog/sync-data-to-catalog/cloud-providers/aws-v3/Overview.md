...
AWS Hosted by Port provides several advantages over the [AWS On-Premise integration](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws-on-premise/installations/installation.md):
