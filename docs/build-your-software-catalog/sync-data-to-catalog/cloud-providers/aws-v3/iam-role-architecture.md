...
This guide describes the IAM role architecture for the **[hosted by Port](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws-v3/installation/hosted-by-port.md)** deployment method. For self-hosted deployments, see the [self-hosted installation guide](/build-your-software-catalog/sync-data-to-catalog/cloud-providers/aws-v3/installation/self-hosted.md) for IAM setup instructions.
:::
