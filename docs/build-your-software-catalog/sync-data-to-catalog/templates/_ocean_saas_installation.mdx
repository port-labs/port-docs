...
You can use the [Real-time (self-hosted)](?installation-methods=real-time-self-hosted#setup) method if you want live events to be ingested into Port immediately.
:::
