...
Alternatively, you can install the integration using the [Self-hosted](?installation-methods=real-time-self-hosted#setup) method to update Port in real time using webhooks.
:::
