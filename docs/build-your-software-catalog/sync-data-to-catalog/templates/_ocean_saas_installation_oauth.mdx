...
import { OceanSaasLiveEventsDescription, OceanSaasLiveEventsTriggers } from "/src/components/ocean-saas-specifics/live-events.jsx";
...
<OceanSaasLiveEventsTriggers id={props.integration} isOAuth={true} />
...
<OceanSaasLiveEventsTriggers id={props.integration} isOAuth={false} />
