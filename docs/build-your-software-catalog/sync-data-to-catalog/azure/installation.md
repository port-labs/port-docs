...
In order to successfully deploy the Azure exporter, it's crucial to ensure that the user who will be responsible for deploying the integration has the appropriate access permissions.
