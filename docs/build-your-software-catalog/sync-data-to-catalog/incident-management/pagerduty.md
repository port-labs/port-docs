...
| Parameter                                       | Description                                                                             | Required |
| ----------------------------------------------- | --------------------------------------------------------------------------------------- | -------- |
| `OCEAN__INTEGRATION__CONFIG__PAGERDUTY_TOKEN`   | The PagerDuty token                                                                     | ✅       |
| `OCEAN__INTEGRATION__CONFIG__PAGERDUTY_API_URL` | The PagerDuty API URL                                                                   | ✅       |
    ...
    steps:
      - name: Run PagerDuty Integration
        run: |
          ...
          -e OCEAN__INTEGRATION__CONFIG__PAGERDUTY_TOKEN=${{ secrets.OCEAN__INTEGRATION__CONFIG__PAGERDUTY_TOKEN }} \
          -e OCEAN__INTEGRATION__CONFIG__PAGERDUTY_API_URL=${{ secrets.OCEAN__INTEGRATION__CONFIG__PAGERDUTY_API_URL }} \
