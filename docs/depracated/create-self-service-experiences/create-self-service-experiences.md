...
- For the documentation about the new routes go to this documentation: [Create self-service actions](/create-self-service-experiences/)
:::

# [Depracated] Create self-service actions
