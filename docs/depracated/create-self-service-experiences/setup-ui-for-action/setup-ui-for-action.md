...
- For the documentation about the new routes go to this documentation: [Setup frontend](/create-self-service-experiences/setup-ui-for-action)
:::

# [Depracated] Setup frontend
...
Click [here](/depracted/create-self-service-experiences/#action-json-structure) for a reminder of an action's JSON structure.
...
See the [user inputs](/create-self-service-experiences/setup-ui-for-action/user-inputs/user-inputs.md) page for more details about the available input types.
