...
1. Copy the `Client ID` and send it to Port along with the `Okta Domain` from the previous step (using Intercom/Slack/mail to [support@getport.io](mailto:support@getport.io)).
