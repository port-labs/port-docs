...
- We support the manual creation of teams on Port, as well as integrating with identity providers, such as [Okta](../sso-providers/oidc/okta.md) and [AzureAD](../sso-providers/azure-ad.md), to import existing teams.
