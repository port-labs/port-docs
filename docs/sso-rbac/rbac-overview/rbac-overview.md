...
Advanced filters and dynamic filters are also available for [dashboard widgets](/customize-pages-dashboards-and-plugins/dashboards/data-widgets) in your catalog or homepage, using the same logic as described in the **Filters** or **Initial Filters** section above.
