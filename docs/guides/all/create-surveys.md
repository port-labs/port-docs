...
{label: "Developer Experience Surveys", value: "dev-experience-surveys"},
{label: "Incident & On-Call Surveys", value: "incident-on-call-surveys"},
{label: "Milestone & Project Surveys", value: "milestone-project-surveys"},
{label: "New Hire Onboarding Surveys", value: "new-hire-onboarding-surveys"},
{label: "Tooling & Error Surveys", value: "tooling-error-feedback"}
]}>
...
<TabItem value="incident-on-call-surveys" label="Incident & On-Call Surveys">
<Tabs groupId="devex-surveys" queryString defaultValue="post-on-call-survey" values={[
{label: "Post On-Call Shift Survey", value: "post-on-call-survey"},
{label: "Post-Incident/Outage Survey", value: "post-incident-survey"},
]}>

<TabItem value="post-on-call-survey" label="Post On-Call Shift Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
<TabItem value="post-incident-survey" label="Post-Incident/Outage Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
<TabItem value="milestone-project-surveys" label="Milestone & Project Surveys">
<Tabs groupId="milestone-project-surveys" queryString defaultValue="10th-pr-survey" values={[
{label: "After 10 PRs Milestone Survey", value: "10th-pr-survey"},
{label: "Sprint/Project Retro Survey", value: "sprint-project-retro-survey"},
]}>

<TabItem value="10th-pr-survey" label="After 10 PRs Milestone Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
<TabItem value="sprint-project-retro-survey" label="Sprint/Project Retro Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
<TabItem value="new-hire-onboarding-surveys" label="New Hire Onboarding Surveys">
<Tabs groupId="new-hire-onboarding-surveys" queryString defaultValue="day-1-survey" values={[
{label: "New Hire Onboarding: Day 1 Survey", value: "day-1-survey"},
{label: "New Hire Onboarding: Week 1 Survey", value: "week-1-survey"},
{label: "New Hire Onboarding: Month 1 Survey", value: "month-1-survey"},
{label: "New Hire Onboarding: Quarter 1 Survey", value: "quarter-1-survey"},
]}>

<TabItem value="day-1-survey" label="New Hire Onboarding: Day 1 Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
<TabItem value="week-1-survey" label="New Hire Onboarding: Week 1 Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
<TabItem value="month-1-survey" label="New Hire Onboarding: Month 1 Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
<TabItem value="quarter-1-survey" label="New Hire Onboarding: Quarter 1 Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
...
{label: "Toolchain or Error Encounter Survey", value: "toolchain-error-encounter-survey"}
]}>

<TabItem value="toolchain-error-encounter-survey" label="Toolchain or Error Encounter Survey">
    <details>
    <summary><b>Survey action configuration (click to expand)</b></summary>
    ``` json showLineNumbers
    {
