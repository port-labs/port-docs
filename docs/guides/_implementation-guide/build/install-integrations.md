...
For example:
- Once you connect your **Jira issue** and **Service** blueprints, you can create a [dashboard widget](https://docs.port.io/customize-pages-dashboards-and-plugins/dashboards/data-widgets) that tracks and displays the open issues in Jira that are related to a specific service.
