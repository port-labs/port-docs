...
[Scorecards](https://docs.port.io/promote-scorecards/overview) are configured per blueprint, and enable you to define and track metrics/standards for your entities, based on their properties.  
