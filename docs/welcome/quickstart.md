...
![Developer Portal Blueprints graph with new Package Blueprint](../../static/img/welcome/quickstart/test/blueprintGraphWithPackage.png)

Click on the `expand` button as shown in the image below:

![Developer Portal Blueprints graph with new Package Blueprint And Expand Marked](../../static/img/welcome/quickstart/test/blueprintGraphWithPackageAndExpandMarked.png)
