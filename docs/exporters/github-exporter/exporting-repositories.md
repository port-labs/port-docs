...
resources:
  - kind: repository
    ...
    port:
      entity:
        mappings:
          identifier: ".name" # the identifier of the entity will be the repository name, and after the creation of the entity the exporter will send `PATCH` requests to update this repository within Port
          title: ".name"
