...
resources:
  - kind: pull-request
    ...
    port:
      entity:
        mappings:
          identifier: ".destination.repository.name + (.id|tostring)" # the identifier of the entity will be the repository name + the pull request id, and after the creation of the entity the exporter will send `PATCH` requests to update this pull request within Port
          title: ".title"
