...
| `resources` | `Object` | GitHub resources that will be mapped to Port Entities and exported to Port. The parsing from GitHub events specified by the `kind` value is performed uisng [JQ](https://stedolan.github.io/jq/manual/) syntax. [visit GitHub exporter for more inforamation](../github-app/exporter/Introduction.md) | `null`
