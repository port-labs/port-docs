...
- [Bitbucket Server Integration](/build-your-software-catalog/sync-data-to-catalog/git/bitbucket-server/bitbucket-server.md)
- [Webhook integration between Bitbucket (self-hosted) server and Port](/build-your-software-catalog/sync-data-to-catalog/git/bitbucket-server/webhook/webhook.md)
