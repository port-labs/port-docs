...
- [Scorecard notifications](./promote-scorecards/port-sender.md#slack-scorecard-reminder-example)
...
- [Initiate scorecards handeling with Jira issues](./promote-scorecards/port-sender.md#syncing-jira-issues)
