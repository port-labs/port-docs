...
Every response returned from the API contains a special debugging header - `X-Trace-Id` which contains an internal trace ID that can be used by Port's support team to troubleshoot issues with an API request.
