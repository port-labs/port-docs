...
In case you encounter an issue with an API request, either performed directly or captured as part of a browsing session in Port's UI, you can send the `X-Trace-Id` header value to support along with your support request.