...
Port API's rate limits are enforced at the **IP level**.

:::note updated API rate limits starting 1.06.2025
Port's API rate limits will be updated on 1.06.2025
...
<details>
<summary>Click here to learn about the updated rate limits</summary>

Port's API rate limits will be updated on 1.06.2025

The table below outlines the updated limits:


| Description | Rate limit   |
|-------------|--------------|
| Unauthenticated requests | 100 requests per 5 minutes |
| Entities API requests    | 30,000 requests per 5 minutes |
