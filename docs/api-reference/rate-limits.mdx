...
Port enforces rate limits on API usage to ensure platform stability and reliable service for all customers.  
These limits are designed to prevent excessive usage and are applied in accordance with fair-use principles.
