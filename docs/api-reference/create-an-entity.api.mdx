  ...
  >
    ...
    <ul>
      ...
      >
        ...
        className={"paramsItem"}
        param={{"schema":{"type":"boolean","default":false},"in":"query","name":"merge","required":false,"description":"If `upsert` is `true` and `merge` is also `true`, this call will update the entity if it already exists.<br/>"}}
      >
