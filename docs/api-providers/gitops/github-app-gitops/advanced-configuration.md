...
| `enableMergeEntity` | `Boolean` | Flag to enable merging an entity instead of overriding the current contents of it. <br/> More info about merging entities can be found at [The Entity Tutorial](https://docs.getport.io/software-catalog/entity/tutorial/#post-request) | `false`
