...
Now we'll define the backend of the action:
  ...
  - Name the workflow `port-slack-reminder.yaml`.
...
3. Now let's create the workflow file that contains our logic. Under `.github/workflows`, create a new file named `port-slack-reminder.yaml` and use the following snippet as its content:

<details>
<summary><b>Github workflow (click to expand)</b></summary>

```yaml showLineNumbers
# port-slack-reminder.yaml
