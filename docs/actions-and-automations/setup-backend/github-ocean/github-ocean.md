...
For complete examples of self-service actions using a GitHub Ocean workflow as the backend, check out the [guides section](/guides?tags=GitHub&tags=Actions).
