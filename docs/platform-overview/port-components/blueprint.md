...
| `spec` | Field with a pre-defined set of allowed values (only 'open-api' is supported currently). Can be used with properties of type `object` only | [open-api](../plugins/open-api)        |
