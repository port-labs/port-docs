...
![Cloudwatch logs example](../../../static/img/self-service-actions/basic-changelog-aws-lambda-example/exampleCloudwatchlogsWithTopicMessage.png)
...
If you want to dive even deeper into Port's execution capabilities, try looking at our [reporting architecture](../port-execution-architecture/port-execution-architecture.md)
